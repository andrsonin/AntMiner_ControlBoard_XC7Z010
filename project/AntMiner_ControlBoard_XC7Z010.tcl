...
#
# AntMiner_ControlBoard_XC7Z010.tcl: Tcl script for re-creating project 'AntMiner_ControlBoard_XC7Z010'
#
# Generated by Vivado on Fri Oct 25 00:54:07 +0300 2024
...
#
# 1. This project restoration tcl script (AntMiner_ControlBoard_XC7Z010.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "F:/Git/AntMiner_ControlBoard_XC7Z010/project/antminer_xc7z010clg400.xdc"
#
# 3. The following remote source files that were added to the original project:-
#
#    "F:/Git/AntMiner_ControlBoard_XC7Z010/src/top_antminer_xc7z010.v"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/antminer_xc7z010clg400.xdc"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/../src/top_antminer_xc7z010.v"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set _xil_proj_name_ "AntMiner_ControlBoard_XC7Z010"
...
set script_file "AntMiner_ControlBoard_XC7Z010.tcl"
...
set file "$origin_dir/../src/top_antminer_xc7z010.v"
...
set_property -name "top" -value "top_antminer_xc7z010" -objects $obj
...
set file "[file normalize "$origin_dir/antminer_xc7z010clg400.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "project/antminer_xc7z010clg400.xdc"
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/AntMiner_ControlBoard_XC7Z010.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/AntMiner_ControlBoard_XC7Z010.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/AntMiner_ControlBoard_XC7Z010.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
